...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total number of deadlines using stream: " + countDeadlineUsingSteams(tasksData));
    ...
    public static int countDeadlineUsingSteams(ArrayList<Task> taskData) {
